"""
competitive_programming_factory/domain/agents/interviewer.py

InterviewerAgent — Imogen, FAANG Principal Engineer.
...
class InterviewerAgent(BaseAgent):
    ...
    def system_prompt(self, candidate_first_name: str) -> str:
        return f"""You are Imogen, a principal engineer conducting a FAANG-level system design \
...
Conduct this interview as a real FAANG principal would — not as a simulation."""
    ...
    def greeting(self, candidate_first_name: str) -> str:
        return (
            f"Alright {candidate_first_name}, I'm Imogen — I'll be running your system design "
