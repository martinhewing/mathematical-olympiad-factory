"""
competitive_programming_factory/domain/agents/registry.py

Maps FSM states → agents.

  TEACH, TEACH_CHECK  → TutorAgent  (Alistair — warm senior FAANG staff engineer)
  All other states    → InterviewerAgent  (Imogen — FAANG principal)
