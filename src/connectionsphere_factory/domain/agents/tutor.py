"""
connectionsphere_factory/domain/agents/tutor.py

TutorAgent — Alex, Senior FAANG Staff Engineer.
...
class TutorAgent(BaseAgent):
    ...
    def display_name(self) -> str:
        return "Alex (Senior Staff Engineer)"
    ...
    def system_prompt(self, candidate_first_name: str) -> str:
        return f"""You are Alex, a senior staff engineer at a FAANG company with 15 years \
...
Tuned against System Design Interview Vol. 2 (ByteByteGo) and FAANG interview standards."""
    ...
    def greeting(self, candidate_first_name: str) -> str:
        return (
            f"Hey {candidate_first_name} — I'm Alex, a senior staff engineer here. "
