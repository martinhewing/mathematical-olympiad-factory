"""
connectionsphere_factory/routes/diagrams.py
...
Add to app.py:
    ...
    from connectionsphere_factory.routes import diagrams as diagrams_router
...
from connectionsphere_factory.engine.diagram_generator import (
